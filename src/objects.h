...
// predeclare classes so they can refernce each other
class Bike_t;
class Driver_t;
...
class Grid_t {
private:
    Tile *tiles; // tiles are stored with 4 tiles per byte. tiles[0] holds the 4 tiles that are in the top left corner in a square formation
public:
    // height and width must be divisible by 2 due to the encoding
